...
PFont secFont, buttonFont, buttonFont2;
color white = #FFFFFF, black = #000000, purple = #C0B2CC, darkPurple = #786a87, gray = #ACABAD, green = #2EFF4F, orange = #F59014, red = #FF7979, red2 = #B70909;
Boolean sec6On=false, sec1On=false, sec9On=false, sec8On=false, sec4On=false, sec7On=false, sec3On=false, picOn=false;

void setup() {
  fullScreen(); //landscape
  population();
  secFont = createFont ("Comic Sans MS", 45);
  buttonFont = createFont ("Comic Sans MS", 25);
  buttonFont2 = createFont ("Comic Sans MS", 12);
}
